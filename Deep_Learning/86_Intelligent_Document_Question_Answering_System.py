...
def ask_llm(question, context):
    prompt = f"""
You are an intelligent document question answering assistant created for .
...
<b>Author:</b> Yash Kedarnath Lute<br><br>
...
Project developed by Yash Kedarnath Lute | Date: 09/05/2026
</div>
""", unsafe_allow_html=True)
